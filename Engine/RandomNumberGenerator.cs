...
namespace Engine
{
    public static class RandomNumberGenerator
    {
        ...
        //2 ways to generate rand numbers in .NET framework: deterministic and non-deterministic
        //deterministic: follows detectable pattern, non-deterministic: can't determine a pattern
        //NumberBetween is non-deterministic but more complex.
        ...
        {
            //get next random value between the values
            //add 1 to max value due to rounding.
